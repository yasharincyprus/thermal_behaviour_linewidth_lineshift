...
while Niter<50 && ssq_n(Niter)>0.001
    Niter=Niter+1;
   [parmin_n,fval_n,exitflag_n]=fminsearch(@ssqmin_cfit_def,par_n,options_n,yData,xData,temp,debye,E1,E2);
    npar_n=parmin_n;
    fit_n=cfit_output_def(temp,xData,debye,E1,E2,npar_n(1,1),npar_n(2,1),npar_n(3,1),npar_n(4,1));
